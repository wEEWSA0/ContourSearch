...
{
    internal static class ConvertorForImage
    {
        public static void getRGB(this Bitmap image, int startX, int startY, int w, int h, ref int[] rgbArray, int offset, int scansize)
        {
